...
class ActionModule_v8_one_input_verb_ablation(ActionModule_v8_one_input):
    def forward(self, _, arg1, __, precomputed_embeddings):
        ...
        verb_embedding = torch.ones_like(verb_embedding).to(self.device) * 0.5
...
class ActionModule_v8_two_inputs_verb_ablation(ActionModule_v8_two_inputs):
