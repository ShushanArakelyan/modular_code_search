# THIS IS A COPY FROM codebert_embedder/__init__.py CREATED FOR HAVING AN INDEPENDENT INSTANCE FOR SCORING MODULE
# WHERE THE WEIGHTS CAN REMAIN FROZEN WHILE THE OTHER INSTANCE IS BEING FINE-TUNED.
...
def init_embedder(_device):
    ...
    print("in scoring codebert: ", _device)
    if 'cuda' in _device:
    ...
    warnings.warn("The weights of the CodeBERT embedder in scoring module have been reset")
    initialized = True
